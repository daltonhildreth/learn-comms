...
glm::vec3 SpotLight::dir() { return _dir; }
void SpotLight::dir(glm::vec3 dir) { _dir = dir; }
float SpotLight::cutoff_100p() { return _cutoff_100p; }
float SpotLight::cutoff_0p() { return _cutoff_0p; }
